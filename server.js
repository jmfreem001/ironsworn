    ...
    [
      {
        "id": 1,
        "name": "face danger",
        "description": "Attempt something risky or react to an imminent threat, envision your action and roll. ",
        "dependent": 0,
        "type": "action",
        "category": "adventure"
      },
      ...
      },
      {
        "id": 12,
        "name": "forge a bond",
        "description": "Spend significant time with a person or community, stand together to face hardships, or make sacrifices for their cause, you can attempt to create a bond",
        "dependent": 0,
        "type": "action",
        "category": "relationship"
      },
      {
        "id": 13,
        "name": "test your bond",
        "description": "Bond is tested through conflict, betrayal, or circumstance,",
        "dependent": 0,
        "type": "action",
        "category": "relationship"
      },
      ...
      },
      {
        "id": 21,
        "name": "battle",
        "description": "Fight a battle, and it happens in a blur, envision your objective and roll. ",
        "dependent": 0,
        "type": "action",
        "category": "combat"
      },
      ...
      },
      {
        "id": 23,
        "name": "face death",
        "description": "You are brought to the brink of death, and glimpse the world beyond",
        "dependent": 1,
        "type": "action",
        "category": "suffer"
      },
      ...
      },
      {
        ...
        "description": "You make significant progress in your quest by overcoming a critical obstacle, completing a perilous journey, solving a complex mystery, defeating a powerful threat, gaining vital support, or acquiring a crucial item, ",
        "dependent": 0,
        "type": "choice",
        "category": "quest"
      },
      {
        ...
        "description": "You achieve what you believe to be the fulfillment of your vow, ",
        "dependent": 0,
        "type": "progress",
        "category": "quest"
      },
      {
        ...
        "description": "You renounce your quest, betray your promise, or the goal is lost to you",
        "dependent": 0,
        "type": "choice?",
        "category": "quest"
      },
      {
        "id": 33,
        "name": "advance",
        "description": "You focus on your skills, receive training, find inspiration, earn a reward, or gain a companion",
        "dependent": 0,
        "type": "choice",
        "category": "quest"
      },
      ...
      },
      {
        "id": 35,
        "name": "ask the oracle",
        "description": "You seek to resolve questions, discover details in the world, determine how other characters respond, or trigger encounters or events,",
        "dependent": 0,
        "type": "roll",
        "category": "fate"
      }
...
app.get('/api/rolls', (req, res) => {
  res.send( 
    [
      ...
      {
        "id": 3,
        "description": " Act with aggressive action, forceful defense, strength, or endurance.",
        "stat": "iron",
        "move": "face danger",
        "move_id": 1,
        "adds": "",
      ...
      {
        "id": 25,
        "description": "USES SECURE AN ADVANTAGE AND GIVE IT TO SOMEONE ELSE IMPLEMENT ONCE I GO T CO OP",
        "stat": "",
        "move": "aid your ally",
        "move_id": 14,
        "adds": "",
      ...
      {
        "id": 28,
        "description": "Moving into position against an unaware foe, or striking without warning",
        "stat": "shadow",
        "move": "enter the fray",
        "move_id": 16,
        "adds": "",
      ...
      {
        "id": 32,
        "description": " your foe has initiative and you fight with them in close quarters",
        "stat": "iron",
        "move": "clash",
        "move_id": 18,
        "adds": "",
      ...
      {
        "id": 33,
        "description": " you exchange a volley at range, or shoot at an advancing foe",
        "stat": "edge",
        "move": "clash",
        "move_id": 18,
        "adds": "",
      ...
      {
        "id": 36,
        "description": "Fight at range, or using your speed and the terrain to your advantage",
        "stat": "edge",
        "move": "battle",
        "move_id": 21,
        "adds": "",
